...
class NetworkPage(QWidget):
    ...
    def init_ui(self):
        ...
        desc = QLabel("Diagnósticos de latência, ping e resolução IP.")
        ...
        self.details_title = QLabel("Detalhes da Rede")
    ...
    def start_network_analysis(self, domain: str):
        ...
        self.details_text.setText("Executando diagnósticos de rede... Por favor, aguarde.")
    ...
    async def _run_network_check(self, domain: str):
        try:
            results = await check_network_diagnostics(domain)
